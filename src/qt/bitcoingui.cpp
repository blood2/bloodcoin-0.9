    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bloodcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bloodcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bod: URIs)"));
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Bloodcoin Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/bitcoin_testnet"), tr("&About Bloodcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bloodcoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bloodcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bloodcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bloodcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a bod: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setStatusTip(tr("Show the Bloodcoin Core help message to get a list with possible Bloodcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("Bloodcoin client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Bloodcoin client") + " " + tr("[testnet]"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bloodcoin network", "", count));
}
...
{
    QString strTitle = tr("Bloodcoin"); // default title
